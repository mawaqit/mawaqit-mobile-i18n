...
class AppLocalizationsUr extends AppLocalizations {
  ...
  @override
  String get adhan_type => 'اذان کی ایک قسم کا انتخاب کریں۔ یہ انتخاب ہر اس نماز میں لاگو ہو گا جس میں اذان کی اطلاع ہو گی۔';

  @override
  String get settings_prayer_Notification_None => 'کوئی نہیں۔';

  @override
  String get prayer_Notification_NoNotification => 'آپ نے اس نماز کے لیے کوئی اطلاع مقرر نہیں کی ہے۔';

  @override
  String get prayer_PreNotification_Description => 'یہ ترتیب آپ کو نماز سے پہلے ایک اطلاع کی وضاحت کرنے کی اجازت دیتی ہے۔';
  ...
  @override
  String get search_HelpText => 'آپ یہ لکھ کر مسجد تلاش کر سکتے ہیں:\n- مسجد کا نام\n- انجمن کا نام\n- شہر، پتہ، ملک... وغیرہ\n\nیا آپ آس پاس کی مساجد تلاش کرنے کے لیے لوکیشن بٹن کو دبا سکتے ہیں۔';

  @override
  String get search_MaxFavMosquesReached => 'آپ اپنی پسندیدہ مساجد کی حد تک پہنچ چکے ہیں۔';

  @override
  String get search_iOs14_message => 'iOS 14 پر GPS کا استعمال کرتے ہوئے تلاش کرنے میں کچھ وقت لگ سکتا ہے، براہ کرم انتظار کریں۔';
  ...
  @override
  String get notification_denied => 'آپ نے نوٹیفکیشن اجازتوں کو مسترد کر دیا ہے، اس لیے آپ کو کوئی نوٹیفکیشن موصول نہیں ہوگا۔';

  @override
  String get at_least_one_mosque => 'جاری رکھنے کے لئے کم از کم ایک مسجد شامل کریں';
  ...
  @override
  String get allow_mawaqit_to_access_my_location => 'مواقیت کو میرے مقام تک رسائی کی اجازت دیں۔ ';

  @override
  String get enable_location_service_from_app_settings => 'ایپ کی ترتیبات سے لوکیشن سروس کو فعال کریں۔';
  ...
  @override
  String get no_mosque_in_selected_area => 'منتخب علاقے میں کوئی مسجد نہیں مل سکی';
  ...
  @override
  String get enter_at_least_3_char => 'تلاش کرنے کے لیے کم از کم 3 حروف درج کریں۔';
  ...
  @override
  String get permission_message1 => 'ہمیں تاخیر کی اطلاع ملی ہے، براہ کرم آف کر دیں۔';
  ...
  @override
  String get qibla_sensor => 'آپ کے آلہ میں وہ سنسر جس کا استعمال مواقيت قبلہ کا تعین کرنے کے لئے کرتی ہے ، وہ متوقع طور پر کام نہیں کر رہا ہے ، جو ہماری قبلہ کی سمت دکھانے کی صلاحیت پر اثر انداز ہو رہا ہے۔';

  @override
  String get connection_not_found => 'کمپاس کیلیبریشن سیٹنگ غیر فعال ہے۔ براہ کرم یقینی بنائیں کہ آپ کا کنکشن آن ہے اور سمت تبدیل کرکے دوبارہ کوشش کریں۔';
  ...
  @override
  String get qibla_Error_LocationDenied => 'مقام کی خدمت کی اجازت مسترد کر دی گئی۔';

  @override
  String get qibla_Error_LocationDeniedForever => 'مقام کی خدمت ہمیشہ کے لیے مسترد کر دی گئی!';
  ...
  @override
  String get mosque_facilities_Info => 'یہ تمام معلومات مسجد کے انچارج لوگ بھرتے ہیں۔';
  ...
  @override
  String get please_update => 'MAWAQIT کا ایک نیا ورژن دستیاب ہے، براہ کرم اپ ڈیٹ کریں۔';
  ...
  @override
  String get tutorial_text_main_mosque => 'آپ کی مرکزی مسجد یہاں دکھائی دیتی ہے۔\nآپ اپنی پسندیدہ مساجد کے درمیان سوئچ کرنے کے لیے بائیں اور دائیں سلائیڈ کر سکتے ہیں۔';

  @override
  String get tutorial_title_countdown => 'اگلی نماز کا اشارہ';

  @override
  String get tutorial_text_countdown => 'یہ الٹی گنتی آپ کو اگلی نماز سے پہلے باقی وقت دکھاتی ہے۔';

  @override
  String get tutorial_title_mosque_info => 'مسجد کی معلومات';

  @override
  String get tutorial_text_mosque_info => 'آپ کی مسجد کے بارے میں سب کچھ: سہولیات، پتہ، فون، میل، عطیہ وغیرہ۔';

  @override
  String get tutorial_title_announcements => 'مسجد کے پیغامات اور اعلانات';

  @override
  String get tutorial_text_announcements => 'آپ کی مسجد سے پیغامات اور اعلانات کے بارے میں اطلاعات یہاں ظاہر ہوں گی۔\nجب آپ اس بٹن کو تھپتھپاتے ہیں، تو آپ کو پوری تفصیلات نظر آئیں گی۔ یہ اعلانات ایک فلیش پیغام، ایک تصویر، یا ویڈیو بھی ہو سکتے ہیں۔';

  @override
  String get onboarding_title_1 => 'اپنی زبان منتخب کریں';

  @override
  String get onboarding_text_1 => 'نیچے دی گئی فہرست سے اپنی پسند کی زبان منتخب کریں۔';

  @override
  String get onboarding_title_2 => 'مواقیت میں خوش آمدید';

  @override
  String get onboarding_text_2 => 'مواقیت ایک ماحولیاتی نظام ہے جو آپ کو نماز کے اوقات کو ٹریک کرنے اور ان کا انتظام کرنے کا ایک نیا طریقہ فراہم کرتا ہے، آپ کے ہاتھ میں موجود ایپلی کیشن اس ماحولیاتی نظام کا حصہ ہے، یہ آپ کو مساجد تلاش کرنے اور اس کی خبروں اور نماز کے اوقات پر عمل کرنے کی اجازت دیتا ہے۔';

  @override
  String get onboarding_title_3 => 'ایک Dark/Light تھیم منتخب کریں۔';

  @override
  String get onboarding_text_3 => 'چاہے آپ کم روشنی والے ماحول میں ہوں یا اپنے فون پر گہرے پس منظر کے رنگوں کو ترجیح دیں، آپ بہتر بصری سکون کے لیے ڈارک موڈ کا فائدہ اٹھا سکتے ہیں۔';

  @override
  String get onboarding_title_4 => 'اپنی مرکزی مسجد کو شامل کریں۔';

  @override
  String get onboarding_text_4 => 'براہ کرم نیچے دی گئی فہرست سے اپنی مرکزی مسجد کا انتخاب کریں یا اپنے موجودہ مقام کے قریب مسجد تلاش کریں۔';
  ...
  @override
  String get onboarding_chose_mosque_please => 'براہ کرم تلاش کی فہرست میں سے ایک مسجد کا انتخاب کریں۔';
  ...
  @override
  String get notification_open_app_body => 'اطلاعات کو برقرار رکھنے کے لیے براہ کرم ایپ کھولیں۔';

  @override
  String get tutorial_title_notification => 'دعا کی اطلاع کا انتخاب کریں۔';

  @override
  String get tutorial_text_notification => 'یہاں آپ نوٹیفکیشن کی ایک قسم، ایتھن، بِپ یا خاموش منتخب کر سکتے ہیں۔';

  @override
  String get search_no_result => 'مواقیت سفیر بنیں اور اپنی مسجد میں ہمارا حل پیش کریں، یہ مفت ہے۔\nhttps://mawaqit.net';

  @override
  String get rate_popin_title => 'MAWAQIT شرح';

  @override
  String get rate_popin_message => 'اگر آپ کو یہ ایپ پسند ہے، تو براہ کرم اس کا جائزہ لینے کے لیے اپنا تھوڑا سا وقت نکالیں!\nیہ واقعی ہماری مدد کرتا ہے۔';
  ...
  @override
  String get message_see_all => 'آپ اس مسجد کے تمام پیغامات اسکرین کے اوپری حصے میں موجود اسپیکر پر کلک کر کے دیکھ سکتے ہیں۔';
  ...
  @override
  String get tutorial_text_iqama => 'یہاں آپ مسجد میں اذان اور اقامت کے درمیان کا دورانیہ دیکھ سکتے ہیں۔';

  @override
  String get calendar_tooltip_download => 'کیلنڈر ڈاؤن لوڈ کریں۔';

  @override
  String get calendar_download_permission_refused => 'ڈاؤن لوڈ کی اجازت یقینی طور پر مسترد کر دی گئی، براہ کرم ڈاؤن لوڈ کی اجازت دیں۔';

  @override
  String get calendar_downloading => 'کیلنڈر ڈاؤن لوڈ ہو رہا ہے...';

  @override
  String get location_service_disabled => 'لوکیشن سروس غیر فعال ہے، براہ کرم اسے فعال کریں۔';

  @override
  String get location_permission_denied => 'مقام کی اجازت نامنظور، براہ کرم اجازت دیں۔';

  @override
  String get location_permission_denied_forever => 'مقام کی اجازت ہمیشہ کے لیے مسترد کر دی گئی، براہ کرم ترتیبات کے صفحہ میں اس کی اجازت دیں۔';

  @override
  String get at_least_one_mosque_error => 'آپ کے پاس کم از کم ایک مسجد ہونی چاہئے۔';
  ...
  @override
  String get not_downloaded_recitation => 'آپ نے ابھی تک کوئی تلاوت ڈاؤن لوڈ نہیں کی ہے۔';

  @override
  String get not_favorite_reciter => 'آپ نے ابھی تک کسی قاری کو پسندیدہ نشان زد نہیں کیا ہے۔';
  ...
  @override
  String get download_quran_popup_downloading_1 => 'ہمیں قرآن کے صفحات ڈاؤن لوڈ کرنے کی ضرورت ہے، اس میں صرف چند سیکنڈ لگیں گے۔ ہم آپ کا موبائل ڈیٹا استعمال کریں گے، ضرورت پڑنے پر Wi-Fi پر سوئچ کریں۔';

  @override
  String get download_quran_popup_downloading_2 => 'ہم صرف آپ کے لیے قرآن تیار کر رہے ہیں، براہ کرم چند سیکنڈ انتظار کریں!';

  @override
  String get download_quran_popup_downloading_3 => 'قرآن کی خوبصورتی دریافت کریں! اس کی لازوال حکمت تک رسائی حاصل کرنے کے لیے \'ڈاؤن لوڈ\' کو دبائیں اور اس کے الہی الفاظ سے متاثر ہوں۔';

  @override
  String get download_quran_popup_confirm_cancel => 'کیا آپ واقعی ڈاؤن لوڈ کو منسوخ کرنا چاہتے ہیں؟ اس ڈیٹا کے بغیر آپ قرآن نہیں پڑھ سکیں گے، صفحات دستیاب نہیں ہوں گے۔';

  @override
  String get download_quran_popup_cancelled => 'کچھ غلط ہو گیا، براہ کرم ڈاؤن لوڈ بٹن کو دوبارہ دبائیں!';
  ...
  @override
  String get notification_not_supported_below_7 => 'آپ کو اذان یا نماز کے اوقات کی اطلاعات موصول نہیں ہو سکیں کیونکہ آپ کا موبائل Android 7 یا اس سے کم ورژن استعمال کرتا ہے۔';

  @override
  String get battery_optimization => 'بیٹری کی بچت کی ترتیبات';

  @override
  String get battery_optimization_subtitle => 'اگر آپ بغیر کسی رکاوٹ کے نماز کی اطلاع حاصل کرنا چاہتے ہیں، تو آپ کو MAWAQIT کے لیے بیٹری کی اصلاح کو بند کرنا ہوگا۔';
  ...
  @override
  String get tutorial_text_foreground_service => 'اس پر ٹیپ کرنے سے آپ \'فور گراؤنڈ سروس\' کو آن یا آف کر سکتے ہیں۔';
  ...
  @override
  String get force_notification_title => 'MAWAQIT اس بات کو یقینی بنانے کے لیے سرگرم ہے کہ نماز کی اطلاعات کو صحیح وقت پر متحرک کیا جائے۔';

  @override
  String get force_notification_body => 'بے شک نماز مومنوں پر مقررہ اوقات میں فرض کی گئی ہے۔ نیسا(103)';

  @override
  String get force_notification_dialog1_body => 'اس آپشن کو فعال کرنے سے، ایپلی کیشن فعال رہے گی تاکہ اس بات کو یقینی بنایا جا سکے کہ نماز کی اطلاعات کو بغیر کسی تاخیر کے صحیح وقت پر متحرک کیا جائے۔ MAWAQIT ایپلی کیشن صرف اسی مقصد کے لیے فعال ہو گی، اور آپ کسی بھی وقت سیٹنگز سے اس آپشن کو آف کر سکتے ہیں۔';

  @override
  String get force_notification_dialog2_body => '\'فورس نوٹیفیکیشنز\' کو فعال کرنے کے بعد نوٹیفکیشن ٹرے کو نیچے سوائپ کریں آپ کو یہ اطلاع وہاں نظر آئے گی۔';

  @override
  String get notification_debugging => 'نوٹیفکیشن ڈیبگنگ';

  @override
  String get notification_debugging_details => 'نوٹیفکیشن ڈیبگنگ فعال ہے۔ اگر آپ اطلاع کی ترتیبات کو تبدیل کرتے ہیں، تو ڈیبگنگ ڈیٹا ضائع ہو جائے گا، اور ڈیبگنگ غیر فعال ہو جائے گی۔';
  ...
  @override
  String get auto_detect_explanation => 'جب آپ اپنے مسجد سے دور ہوتے ہیں، ایپ خود بخود تجویز کرے گی کہ آپ اپنے مقام کے مبنی سب سے قریبی مسجد کا تلاش کریں۔';

  @override
  String get auto_detect_location_title => 'یہ لگتا ہے کہ آپ اپنے مسجد سے دور ہیں';

  @override
  String get auto_detect_location_message => 'کیا آپ چاہتے ہیں کہ آپ نماز کے صحیح اوقات کے لیے نزدیک ترین مسجد کو تلاش کریں؟';

  @override
  String get donation_success_toast => 'عطیہ کامیابی سے ہو گیا';

  @override
  String get donation_success => 'آپ کے عطیہ کا شکریہ، اللہ آپ کو جزائے خیر دے۔';
  ...
  @override
  String get google_pay_not_available => 'Google Pay اس ڈیوائس میں دستیاب نہیں ہے';

  @override
  String get error_performing_donation => 'عطیہ کرنے کی کوشش کرتے وقت ایک خرابی تھی';
  ...
  @override
  String get change_mosque_order => 'ترتیب تبدیل کرنے اور مرکزی مسجد مقرر کرنے کے لیے مساجد کو گھسیٹیں اور چھوڑیں';
  ...
  @override
  String get cant_download_more_than_3 => 'ایک وقت میں 3 سے زیادہ ڈاؤن لوڈ نہیں کر سکتے۔';
  ...
  @override
  String get no_virtual_mosque_found => 'معذرت، ہمیں آپ کے ارد گرد کوئی مسجد نہیں ملی';
  ...
  @override
  String get no_bookmark_ayah => 'کوئی بُک مارکس دستیاب نہیں ہیں۔ برائے مہربانی اس آیت پر لمبی دبا کر رکھیں جسے آپ بُک مارک کرنا چاہتے ہیں۔';
  ...
  @override
  String get highlight_next_prayer_after_Iqama => 'اقامت کے بعد اگلی نماز کو نمایاں دکھائیں';
  ...
  @override
  String get updates_draw => 'تازہ ترین معلومات حاصل کریں اور انعامات جیتنے کے لیے قرعہ اندازی میں شامل ہوں';

  @override
  String get email_info => 'یہ ای میل آپ سے رابطہ کرنے کے لیے استعمال کی جائے گی اگر آپ قرعہ اندازی جیت جاتے ہیں';

  @override
  String get enter_email => 'اپنا ای میل درج کریں';

  @override
  String get email_privacy => 'MAWAQIT اس ای میل کو کسی کے ساتھ شیئر نہیں کرے گا۔ یہ ہر قرعہ اندازی کے بعد خود بخود ہمارے ڈیٹا بیس سے حذف ہو جائے گا';

  @override
  String get submit => 'جمع کرائیں';

  @override
  String get disclaimer => 'MAWAQIT درج شدہ پروجیکٹس کے ذریعہ فراہم کردہ خدمات یا مصنوعات کی کوئی ذمہ داری قبول نہیں کرتا۔ براہ کرم اپنی تحقیق خود کریں';
  ...
  @override
  String get prayer_times_set_by_mosque => 'نماز کے اوقات اور یہاں موجود تمام معلومات مسجد کی طرف سے مقرر کی جاتی ہیں، نہ کہ MAWAQIT کی طرف سے';
  ...
  @override
  String get improved_Hafs_Rewaya_Force_Update => 'ہم نے آپ کی حفص روایت کو بہتر بنا دیا ہے۔ ابھی ڈاؤن لوڈ کریں، تفسیر دریافت کریں اور کسی بھی آیت پر لمبا دباکر تلاوت سنیں۔';

  @override
  String get mawaqit_three_sixty_description => 'نئی متحرک گھڑی کے ساتھ نماز کے اوقات کو جیتا جاگتا دیکھیں۔';

  @override
  String get hnpai_User_Guidance_MAWAQIT_360 => 'ویو استعمال کرتے وقت آپ اس سیٹنگ کو بند نہیں کر سکتے۔ 360';
  ...
  @override
  String get most_widespread_riwayah => 'دنیا بھر میں سب سے زیادہ پڑھی جانے والی روایت';

  @override
  String get warsh_an_nafi => 'ورش عن نافع';

  @override
  String get popular_across_north_west_africa => 'شمالی اور مغربی افریقہ میں مقبول';
  ...
  @override
  String get calendar_allow_access_mawaqit => '\"براہ کرم اپنے ایونٹس MAWAQIT 360 پر دکھانے کے لیے کیلنڈر کی رسائی کی اجازت دیں۔\"';
  ...
  @override
  String get calendar_select_for_mawaqit => 'وہ کیلنڈرز منتخب کریں جو آپ MAWAQIT 360 پر دکھانا چاہتے ہیں۔';
