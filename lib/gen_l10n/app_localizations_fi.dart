...
class AppLocalizationsFi extends AppLocalizations {
  ...
  String get download_quran_popup_downloading_3 =>
      'Tutustu Koraanin kauneuteen! Napauta \'Lataa\' päästäksesi käsiksi sen ajattomaan viisauteen ja inspiroidaksesi sen jumalallisia sanoja.';
  ...
  String get update_new_version =>
      'Koraanin uusi versio on ladattavissa. Napauta \'Update\' päästäksesi uusimpiin parannuksiin ja jatkaaksesi matkaa jumalallisella viisaudella';
  ...
  String get highlight_next_prayer_after_Iqama =>
      'Korosta seuraava rukous Iqaman jälkeen';
  ...
  String get selecet_audio_before_delete =>
      'Sinun täytyy lisätä toinen äänitiedosto ilmoituksia varten ennen kuin poistat valitun äänitiedoston';

  @override
  String get addding_file_prompt =>
      'Voit lisätä useita äänitiedostoja, mutta varmista, että et lisää samaa äänitiedostoa.';

  @override
  String get ios_audio_file_picking_prompt =>
      'Ole hyvä ja valitse äänitiedosto, jonka kesto on enintään 30 sekuntia. Pitkäaikainen äänitiedosto voi keskeyttää rukousilmoituksen.';
  ...
  String get updates_draw =>
      'Hanki päivityksiä ja osallistu tasapeliin voittaaksesi herkkuja';

  @override
  String get email_info =>
      'Tätä sähköpostia käytetään ottamaan sinuun yhteyttä, jos voitat tasapelin';
  ...
  String get email_privacy =>
      'MAWAQIT ei jaa tätä sähköpostia kenellekään. Sähköposti poistetaan automaattisesti tietokannastamme jokaisen tasapelin jälkeen';
  ...
  String get disclaimer =>
      'MAWAQIT on vapautunut vastuusta listattujen projektien ehdottamista palveluista tai tuotteista. Tee oma due diligence ja tutkimus';
  ...
  String get draw_info =>
      'Yksi piirtää joka kuukausi. Joka 24 h voit lisätä uuden lipun lisätä mahdollisuuttasi voittaa!';
  ...
  String get select_device_audo_for_ios_propmpt =>
      'Valitse äänitiedosto, ja me muunnamme sen iOS-yhteensopivaan muotoon ja leikkaamme sitä 30 sekunnin iOS-alustan rajoituksista.';
  ...
  String get sure_remove_rewaya =>
      'Oletko varma, että haluat poistaa tämän Reway?';
  ...
  String get notified_boost =>
      'Saat ilmoituksen MAWAQIT Boost -projektien uusimmista päivityksistä.';

  @override
  String get contact_us_boost =>
      'Jos haluat listata projektisi tähän, ota yhteyttä';

  @override
  String get prayer_times_set_by_mosque =>
      'Rukousajat ovat moskeijan asettamia, ei MAWAQIT';
  ...
  String get delete_recitations_message =>
      'Oletko varma, että haluat poistaa kaikki ladatut reseptit?';

  @override
  String get downloaded_deleted_successfully =>
      'Kaikki reseptit poistettu onnistuneesti';
  ...
  String get compass_calibration =>
      'Kompassin kalibrointiasetus ei ole käytössä. Kallistele ja siirrä puhelinta 3 kertaa kahdeksankertaisessa liikkeessä kuten tässä';
  ...
  String get improved_Hafs_Rewaya_Force_Update =>
      'Olemme parantaneet Hafs Rewaya. Lataa nyt tutustua Tafsir ja kuunnella reseptejä klikkaamalla mitä tahansa Ayah';

  @override
  String get mawaqit_three_sixty_description =>
      'Katso rukouksen ajat tulevat elämään uuden animoituja kello';

  @override
  String get hnpai_User_Guidance_MAWAQIT_360 =>
      'Tämä ominaisuus on käytössä 360° näkymän ollessa käytössä eikä sitä voi kytkeä pois päältä';

  @override
  String get mawaqit_three_sixty_beta => 'MAWAQIT 360 (Beta)';

  @override
  String get three_sixty_setting => '360 Asetukset';

  @override
  String get behavior => 'Käyttäytyminen';

  @override
  String get next_prayer_open => 'Seuraava rukous';

  @override
  String get all_prayer_closed => 'Kaikki suljettu';

  @override
  String get recomended_next_prayer => 'Suositeltu: Seuraava rukous vain';

  @override
  String get live_preview => 'Live Esikatselu';

  @override
  String get font_Size_Normal => 'Normaali';

  @override
  String get font_Size_Large => 'Suuri';

  @override
  String get all_Prayer_Open => 'Kaikki auki';

  @override
  String get settingFontSize => 'Font Size';

  @override
  String get last_Third_Of_The_Night => 'Viimeinen Kolmas Yö';

  @override
  String get shaykh_aminuddin_muhammad => 'Šeikki Aminuddin Muhammad';

  @override
  String get hafs_an_asim => 'Hafs ʿan ʿĀṣim';

  @override
  String get most_widespread_riwayah => 'Maailman laajimmin levinnyt riwāyah';
  ...
  @override
  String get open_in_mawaqit_app => 'Avaa tämä moskeija MAWAQIT sovelluksessa';
  ...
  @override
  String get location_permission_required => 'Sijaintilupa vaaditaan';
  ...
  @override
  String get dr_abu_bakr_muhammad => 'Tohtori Abu Bakr Muhammad Zakaria';
